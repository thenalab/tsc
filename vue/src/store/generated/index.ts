...
import ThenalabTscThenalabTscTsc from './thenalab/tsc/thenalab.tsc.tsc'
import ThenalabTscThenalabTscWasm from './thenalab/tsc/thenalab.tsc.wasm'
...
export default { 
  ...
  ThenalabTscThenalabTscTsc: load(ThenalabTscThenalabTscTsc, 'thenalab.tsc.tsc'),
  ThenalabTscThenalabTscWasm: load(ThenalabTscThenalabTscWasm, 'thenalab.tsc.wasm'),
